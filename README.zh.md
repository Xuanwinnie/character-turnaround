...
生成轉面圖時，Skill 會先判斷配件的實際附著位置、角色自身左右、前後遮擋與尾巴根部連接，再推導各視角的可見性。胸前的領巾結、蝴蝶結或徽章轉到背面後應被身體遮住，不得直接複製成背面裝飾；尾巴等非對稱特徵則依角色自身左右隨視角旋轉，不以畫面左右任意鏡像。若背面出現正面專屬配件、尾巴換到不合理的一側，或附著點不連續，該視角會被判定為 QA 失敗並重試一次。
